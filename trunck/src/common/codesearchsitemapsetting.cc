...
void CodeSearchSitemapSetting::ResetToDefault() {
  ...
  included_urls_.push_back(Url("/*.java"));
  included_urls_.push_back(Url("/*.cc"));
  included_urls_.push_back(Url("/*.h"));
  included_urls_.push_back(Url("/*.cpp"));
  included_urls_.push_back(Url("/*.cxx"));
  included_urls_.push_back(Url("/*.c"));
  included_urls_.push_back(Url("/*.vb"));
