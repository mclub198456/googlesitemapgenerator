...
class SiteDataManager {
 public:
  ...
  // Update robots.txt with or without Sitemap tag.
  // TODO: this method should be moved to other place.
  virtual bool UpdateRobotsTxt(bool include_sitemap, const char* sitemap) = 0;
};
...
class SiteDataManagerImpl : public SiteDataManager {
 public:
  ...
  virtual bool UpdateRobotsTxt(bool include_sitemap, const char* sitemap);
 ...
 private:
  ...
  // All coming URLs will be filtered by it before going to table in memory.
