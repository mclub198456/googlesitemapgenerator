...
class SiteSetting : public BaseSetting {
 public:
  ...
  void set_max_url_in_memory(int max_url_in_memory) {
    ...
    SaveAttribute("max_url_in_memory_", max_url_in_memory_);
  }

  // get/set UrlReplacement
  const std::vector<UrlReplacement>& url_replacements() const {
    return url_replacements_;
  }
  void set_url_replacements(std::vector<UrlReplacement>& replaces) {
  ...
  void set_max_url_life(int max_url_life) {
    ...
    SaveAttribute("max_url_life", max_url_life_);
  }
 ...
 private:
  ...
  std::vector<UrlReplacement> url_replacements_;
