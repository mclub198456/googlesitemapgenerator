...
class BaseFilter {
 public:
  ...
  // Initialize from given setting file.
  // It loads configuration from webserver and given setting file. And then it
  // delegates the call to the overloaded method.
  bool Initialize(const char* settingfile);
